 ...
 */
public class TooAllMove implements StrategyMoveComputer {
                    ...
                    if (count == 2) {
                        if (lostCell.getRow() + 1 < amountCell && lostCell.getCol() + 1 < amountCell) {
                            if (gameTable.isEmpty(new Cell(lostCell.getRow() + 1, lostCell.getCol() + 1))) {
                                ...
                                return true;
                            } else if (lostCell.getRow() - 2 >= 0 && lostCell.getCol() - 2 >= 0) {
                                if (gameTable.isEmpty(new Cell(lostCell.getRow() - 2, lostCell.getCol() - 2))) {
                                    gameTable.setSign((new Cell(lostCell.getRow() - 2, lostCell.getCol() - 2)), sign);
                                    return true;
                                }
                            }
                        } else if (lostCell.getRow() - 2 >= 0 && lostCell.getCol() - 2 >= 0) {
                    ...
                    if (count == 2) {
                        if (lostCell.getRow() - 1 >= 0 && lostCell.getCol() + 1 < amountCell) {
                            if (gameTable.isEmpty(new Cell(lostCell.getRow() - 1, lostCell.getCol() + 1))) {
                                gameTable.setSign(new Cell(lostCell.getRow() - 1, lostCell.getCol() + 1), sign);
                                return true;
                            } else if (lostCell.getRow() + 2 < amountCell && lostCell.getCol() - 2 >= 0) {
                                if (gameTable.isEmpty(new Cell(lostCell.getRow() + 2, lostCell.getCol() - 2))) {
                                    gameTable.setSign((new Cell(lostCell.getRow() + 2, lostCell.getCol() - 2)), sign);
                                    return true;
                                }
                ...
                if (gameTable.getSign(cell) == (sign)) {
                    ...
                    if (count == 2) {
                        if (gameTable.isEmpty(lostCell)) {
                            ...
                            if (gameTable.isEmpty(new Cell(lostCell.getRow() - 2, lostCell.getCol()))) {
                                gameTable.setSign((new Cell(lostCell.getRow() - 2, lostCell.getCol())), sign);
                                return true;
                            }
                ...
                if (gameTable.getSign(cell) == (sign)) {
                    ...
                    if (count == 2) {
                        if (gameTable.isEmpty(lostCell)) {
                            gameTable.setSign(lostCell, sign);
                            return true;
                        } else if (lostCell.getCol() - 2 >= 0) {
                            if (gameTable.isEmpty(new Cell(lostCell.getRow(), lostCell.getCol() - 2))) {
                                gameTable.setSign((new Cell(lostCell.getRow(), lostCell.getCol() - 2)), sign);
                                return true;
                            }
